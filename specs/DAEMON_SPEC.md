# Spark Daemon - Technical Specification
...
The Spark Daemon is a standalone Node.js process that:
1. Watches the Obsidian vault for file changes
2. Parses markdown files for Spark syntax
3. Executes commands, loads context, calls AI
4. Writes results back to files
5. Sends notifications to the plugin

**Key principle:** The daemon does ALL the intelligence. The plugin is just UI.
