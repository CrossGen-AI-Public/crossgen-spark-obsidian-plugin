...
This directory contains comprehensive tests for the Spark engine. All tests are designed to run without making actual API calls or incurring costs.
...
- `SparkEngine.test.ts` - Mocks all engine operations including AI calls
- `EngineInspector.test.ts` - Mocks AI integration
...
├── SparkEngine.test.ts     # Main engine tests
└── README.md               # This file
```
