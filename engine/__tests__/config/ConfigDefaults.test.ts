...
describe('ConfigDefaults', () => {
    describe('DEFAULT_SPARK_CONFIG', () => {
        it('should have valid engine configuration', () => {
            expect(DEFAULT_SPARK_CONFIG.engine.watch.patterns).toEqual(['**/*.md']);
            expect(DEFAULT_SPARK_CONFIG.engine.watch.ignore).toContain('.git/**');
            expect(DEFAULT_SPARK_CONFIG.engine.debounce_ms).toBe(300);
        });
    ...
    describe('deepMerge', () => {
        ...
        it('should merge SparkConfig correctly', () => {
            ...
            expect(result.engine.watch.patterns).toEqual(['custom/*.md']);
            expect(result.engine.debounce_ms).toBe(500);
