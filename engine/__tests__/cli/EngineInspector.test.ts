/**
 * Tests for EngineInspector
 */

import { describe, it, expect, beforeEach, afterEach, jest } from '@jest/globals';
import { EngineInspector } from '../../src/cli/EngineInspector.js';
...
describe('EngineInspector', () => {
    ...
    beforeEach(async () => {
        ...
        engine = new SparkEngine(vault.path);
        await engine.start();
        inspector = new EngineInspector(engine);
    });
    ...
    describe('recordStart and recordStop', () => {
        it('should track engine start time', async () => {
            inspector.recordStart();
