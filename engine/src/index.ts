/**
 * Spark Engine Main Export
 * Export all public APIs for external use
 */

export type { InspectorState, ProcessingEvent } from './cli/EngineInspector.js';
// Export CLI tools
export { EngineInspector } from './cli/EngineInspector.js';
export {
...
// Export core engine
export { SparkEngine } from './main.js';
